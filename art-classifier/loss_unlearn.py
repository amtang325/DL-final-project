...
def main():
    ...
    #Stage 1
    optimizer_config = {"optimizer_type": "adam", "lr": 1e-4, "weight_decay": 1e-5}
    optimizer = get_optimizer(my_resnet, optimizer_config)
    unlearn_loss(model=my_resnet, optimizer=optimizer, data_dir="./data/", batch_size=32, num_epochs=1)
